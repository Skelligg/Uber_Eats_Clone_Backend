...
public class MarkDishAvailableUseCaseImpl implements MarkDishAvailableUseCase {
    ...
    public MarkDishAvailableUseCaseImpl(LoadDishPort loadDishPort, LoadFoodMenuPort loadFoodMenuPort, List<UpdateFoodMenuPort> updateFoodMenuPorts, UpdateDishPort updateDishPort) {
